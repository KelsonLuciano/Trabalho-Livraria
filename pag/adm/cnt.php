...
<main>
    ...
    <?php
        ...
        <div id="usu" class="d-flex justify-content-evenly col">
            <?php echo '<h2> Nome: '.$lv['nome'].'</h2>'?>
            <?php echo '<h2> id cliente: '.$lv['cod_cliente'].'</h2>'?>
            <?php echo '<h2> CPF: '.$lv['cpf'].'</h2>'?>
            <a href="../../model/exu.php?id=<?php echo $lv['cod_cliente'] ?>" class="exl">excluir</a>
            <a href="../../model/edu.php?id=<?php echo $lv['cod_cliente'] ?>" class="exl">editar</a>
        </div>
        <?php
            }
        ?>
